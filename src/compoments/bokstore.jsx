   ...
   <div className="flex bg-white rounded-lg shadow-[0_4px_8px_rgba(0,0,0,0.1)] mb-5 overflow-hidden transition-shadow duration-300 hover:shadow-[0_8px_16px_rgba(0,0,0,0.2)]">
     ...
     <div className="p-5 flex-grow">
       ...
       <div className="flex justify-between items-center">
         <button onClick={show}  className="bg-[rgba(0,172,163,0.12)] text-[#00E7C8] py-2.5 px-5 text-xs rounded-md cursor-pointer transition-all duration-300 hover:bg-[#202020] hover:-translate-y-0.5">
         شراء
         </button>
       </div>
     </div>
         ...
         <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
              <div className="bg-white p-8 rounded-lg shadow-lg w-96">
                <div className="flex justify-end">
                  <button onClick={show}  className="text-gray-1000">
                    &times;
                  </button>
                </div>
